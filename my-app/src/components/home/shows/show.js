...
<p className='show-content' style={{color:"white"}}>Watch full seasons of exclusive streaming series, current-season episodes, hit movies, Hulu <br /> Originals, kids shows, and more.</p>
</div>
</div>
<div className='shows'>
<div className='show-lists'>
	<a href='#'><img src={list1} alt="Hulu Shows" width={280} height={440} /></a>
	<a href='#'><img src={list2} alt="Hulu Shows" width={280} height={440} /></a>
	<a href='#'><img src={list3} alt="Hulu Shows" width={280} height={440} /></a>
	<a href='#'><img src={list4} alt="Hulu Shows" width={280} height={440} /></a>
</div>
</div>
