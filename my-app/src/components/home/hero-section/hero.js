  ...
  return (
    <div className='hero-container'>
      ...
      <div className='hero-btn-container'>
        <Link to = './login' className='hero-btn'>GET THIS DEAL</Link>
      </div>
      ...
      <div className={`${styles.spaceEvenly} hero-footer`}>
        <img src={heroImage2} alt='Hulu Hero' width={300} height={100} />
        <div className='hero-footer-content'>
          <p className={styles.fontGreenBold}>DISNEY+, HULU, MAX BUNDLE</p>
          <h3>Save 42% per month with a Disney+, Hulu, Max Bundle. Plans start  at $16.99/mo.</h3>
          <p className={styles.fontWhite18px}>Savings compared to regular monthly price of each service.</p>
        </div>
