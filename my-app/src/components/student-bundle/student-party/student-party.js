  ...
  return (
	<div className='party-container'>
	  ...
	  <div className='party-portion-a'>
		...
		<p className='party-content'>Missing your crew? Watch together, even when you’re apart with Watch Party. You and up to seven friends can stream and chat together as long as you’re all Hulu subscribers.</p>
	  </div>
