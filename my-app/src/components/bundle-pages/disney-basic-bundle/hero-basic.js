  ...
  return (
	 <div className='bundle-hero'>
		  ...
		  <div>
			...
			<p className='hero-content1'>Get your favorite stories, Originals, and live sports with <br /> Disney+, Hulu, ESPN+ Bundle Basic, which includes Hulu, <br /> Disney+, and ESPN+, all with ads.</p>
		  </div>
