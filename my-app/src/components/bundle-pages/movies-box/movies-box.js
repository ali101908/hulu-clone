...
<img src={m12} alt='img1' />
		...
		<div className='movies-portion-a'>
			...
			<p className='box-content'>Stream thousands of live events from top leagues including the NFL, NHL, MLB, UFC, <br />LALIGA, and more.** Plus, follow the best stories in sports with the complete 30 for 30 <br /> library, exclusive originals and premium articles.</p>
			<p className='copyright' >
